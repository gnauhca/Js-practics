...
var zzc={
		...
		ani : {
			...
			aniGo : function(){//console.log(this)
				...
				//div1.innerHTML=this.tasks.length;
			}
		},
		moveTo : function(ele,sizeInfo,time,callback){
			time = time?time:1000;				
		...
		fade:function(ele,fadeNum,time,callback){
			...
			var fadeInfo = {
				ini : zzc.getOpacity(ele),
				fnl : fadeNum,
				fOffset : fadeNum-zzc.getOpacity(ele),
				step : (fadeNum-zzc.getOpacity(ele))/(time/this.ani.gapTime),
				hasGo : 0
			};
